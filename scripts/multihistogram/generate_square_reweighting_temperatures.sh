...
OUTDIR="${1:-data/temperatures/square}"
mkdir -p "$OUTDIR"

# Temperature windows used for the square-lattice
...
echo "Generating square-lattice reweighting temperature files in: $OUTDIR"
